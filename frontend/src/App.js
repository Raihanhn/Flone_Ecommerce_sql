...
const AllOrders = lazy(() => import("./pages/other/AllOrders"));
const AllUsers = lazy(() => import("./pages/other/AllUsers"));
...
const SearchByOID = lazy(() => import("./pages/other/SearchByOID"));
        ...
        <ScrollToTop>
          ...
          >
            ...
            /> */}
              ...
              <Route
                path={process.env.PUBLIC_URL + "/allorders"}
                element={<AllOrders />}
              />
              <Route
              ...
              <Route
                path={process.env.PUBLIC_URL + "/searchoid"}
                element={<SearchByOID />}
              />
